...
if len(sys.argv) not in [3]:
  print("Usage: patchsprings.py <transformmap> <N>")
  print("transformmap is a file containing the relationships between all patches to be placed, ordered so that a patch has at least one already-placed neighbour at initial placement")
  exit(0)

# TODO Load transforms from rel.csv file
  
patchLimit = int(sys.argv[2])

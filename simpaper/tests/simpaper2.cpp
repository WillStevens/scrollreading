...
void InitialiseSeed(void)
{
  ...
  paperPos[SHEET_SIZE/2][SHEET_SIZE/2][1] = 128;
  paperPos[SHEET_SIZE/2][SHEET_SIZE/2][2] = 150;

  paperPos[SHEET_SIZE/2][SHEET_SIZE/2+1][0] = 128+STEP_SIZE;
  paperPos[SHEET_SIZE/2][SHEET_SIZE/2+1][1] = 128;
  paperPos[SHEET_SIZE/2][SHEET_SIZE/2+1][2] = 150;

  paperPos[SHEET_SIZE/2+1][SHEET_SIZE/2][0] = 128;
  paperPos[SHEET_SIZE/2+1][SHEET_SIZE/2][1] = 128;
  paperPos[SHEET_SIZE/2+1][SHEET_SIZE/2][2] = 150+STEP_SIZE;

  paperPos[SHEET_SIZE/2+1][SHEET_SIZE/2+1][0] = 128+STEP_SIZE;
  paperPos[SHEET_SIZE/2+1][SHEET_SIZE/2+1][1] = 128;
  paperPos[SHEET_SIZE/2+1][SHEET_SIZE/2+1][2] = 150+STEP_SIZE;
...
{  
  ...
  LoadVectorField("test_switchdetect_smooth.csv");
  ...
  Output("test_switchdetect_simout.csv");
  StressOutput("test_switchdetect_stressout.csv");

...
{
  paperPos[SHEET_SIZE/2][SHEET_SIZE/2][0] = SEED_X;
  paperPos[SHEET_SIZE/2][SHEET_SIZE/2][1] = SEED_Y;
  paperPos[SHEET_SIZE/2][SHEET_SIZE/2][2] = SEED_Z;
  SetVectorField(SHEET_SIZE/2,SHEET_SIZE/2);
  
  paperPos[SHEET_SIZE/2][SHEET_SIZE/2+1][0] = SEED_X+STEP_SIZE;
  paperPos[SHEET_SIZE/2][SHEET_SIZE/2+1][1] = SEED_Y;
  paperPos[SHEET_SIZE/2][SHEET_SIZE/2+1][2] = SEED_Z;
  ...
  paperPos[SHEET_SIZE/2+1][SHEET_SIZE/2][0] = SEED_X;
  paperPos[SHEET_SIZE/2+1][SHEET_SIZE/2][1] = SEED_Y;
  paperPos[SHEET_SIZE/2+1][SHEET_SIZE/2][2] = SEED_Z+STEP_SIZE;
  ...
  printf("These are the seeds\n");
  printf("%d %d\n",SHEET_SIZE/2,SHEET_SIZE/2);
  printf("%d %d\n",SHEET_SIZE/2,SHEET_SIZE/2+1);
  printf("%d %d\n",SHEET_SIZE/2,SHEET_SIZE/2-1);
  printf("%d %d\n",SHEET_SIZE/2+1,SHEET_SIZE/2);
  printf("%d %d\n",SHEET_SIZE/2-1,SHEET_SIZE/2);
}
...
{  
  if (argc != 4)
  {
	printf("Usage: simpaper3 <vector field zarr> <surface points output> <stress output>\n");
	return -1;
  }
  ...
  for(int i = 0; i<600; i++)
  {
    ...
    for(int y = 0; y<SHEET_SIZE; y++)
    {
	  ...
	  { 
        ...
        if (px>=0 && px<VF_SIZE && py>=0 && py<VF_SIZE && pz>=0 && pz<VF_SIZE)
		{
		  if (GetDistanceAtPoint(pointInt(px,py,pz))>0)
			  okayToFill = false;

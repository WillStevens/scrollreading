...
ZARR_2 *ZARROpen_2(const char *location)
{
	ZARR_2 *z = (ZARR_2 *)malloc(sizeof(ZARR_2));
...
int ZARRFlushOne_2(ZARR_2 *z, int i)
{
    if (z->written[i])
	{
...
int ZARRCheckChunk_2(ZARR_2 *z, int c[4])
{	
...
float ZARRRead_2(ZARR_2 *za,int x0,int x1,int x2,int x3)
{
	int c[4],m[4];
    c[0] = x0/128;
    m[0] = x0%128;
...
void ZARRReadN_2(ZARR_2 *za,int x0,int x1,int x2,int x3,int n, float *v)
{
	int c[4],m[4];
    c[0] = x0/128;
    m[0] = x0%128;
...
int ZARRWrite_2(ZARR_2 *za,int x0,int x1,int x2,int x3,float value)
{
	int c[4],m[4];
    c[0] = x0/128;
    m[0] = x0%128;
...
void ZARRWriteN_2(ZARR_2 *za,int x0,int x1,int x2,int x3,int n, float *v)
{
	int c[4],m[4];
    c[0] = x0/128;
    m[0] = x0%128;
...
void ZARRNoCheckWriteN_2(ZARR_2 *za,int x0,int x1,int x2,int x3,int n, float *v)
{
	int c[4],m[4];
    c[0] = x0/128;
    m[0] = x0%128;

...
void InitialiseSeed(void)
{
  ...
  paperPos[SHEET_SIZE/2][SHEET_SIZE/2+1][0] = 129;
  ...
  paperPos[SHEET_SIZE/2+1][SHEET_SIZE/2][2] = 129;

  paperPos[SHEET_SIZE/2+1][SHEET_SIZE/2+1][0] = 129;
  paperPos[SHEET_SIZE/2+1][SHEET_SIZE/2+1][1] = 148;
  paperPos[SHEET_SIZE/2+1][SHEET_SIZE/2+1][2] = 129;
